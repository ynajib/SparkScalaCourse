...
object PopularMoviesNicer {
  ...
  def loadMovieNames() : Map[Int, String] = {
    ...
    var movieNames:Map[Int, String] = Map()
     ...
     val lines = Source.fromFile("/Users/sromero/Development/SparkScala/ml-100k/u.item").getLines()
  ...
  def main(args: Array[String]) {
    ...
    // Create a broadcast variable of our ID -> movie name map, broadcast to every node on the cluster
    val nameDict = sc.broadcast(loadMovieNames())
    
    // Read in each rating line
    val lines = sc.textFile("/Users/sromero/Development/SparkScala/ml-100k/u.data")
