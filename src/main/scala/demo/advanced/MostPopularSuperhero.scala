...
object MostPopularSuperhero {
  ...
  def main(args: Array[String]) {
    ...
    val names = sc.textFile("/Users/sromero/Development/SparkScala/marvel-names.txt")
    val namesRdd = names.flatMap(parseNames)
    
    // Load up the superhero co-apperarance data
    val lines = sc.textFile("/Users/sromero/Development/SparkScala/marvel-graph.txt")
    ...
    // Find the max # of connections based on the key, thats why we had to flip
